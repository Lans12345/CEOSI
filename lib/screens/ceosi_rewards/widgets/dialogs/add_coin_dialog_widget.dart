...
class AddCoinDialogWidget extends StatefulWidget {
  late String id;
  late String name;
  ...
  @override
  State<AddCoinDialogWidget> createState() => _AddCoinDialogWidgetState();
}

class _AddCoinDialogWidgetState extends State<AddCoinDialogWidget> {
